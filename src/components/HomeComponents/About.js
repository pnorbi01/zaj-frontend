...
function About() {
    return (
        <section className="flex flex-row justify-center items-start w-full p-3 relative">
            <div className="before:content-[''] rounded-lg absolute -top-24 h-24 w-0.5 bg-gradient-to-b from-white to-warning-500"></div>
            <div className="about-content flex flex-col justify-center items-center w-2/3 p-5">
                ...
                <div className="group flex flex-row justify-center items-center gap-3 mt-5">
                    <Link href="/about" className="about-link text-lg text-gray-600 hover:cursor-pointer">Saznajte više o nama</Link>
                    <svg 
