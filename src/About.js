...
function About() {
    return (
        <section className="flex flex-row justify-center items-start w-full h-80 p-3 relative">
            <div className="before:content-[''] rounded-lg absolute bottom-0 h-24 w-0.5 bg-gray-500"></div>
            <div className="flex flex-col justify-center items-center w-2/3 p-5">
                ...
                <div className="group flex flex-row justify-center items-center gap-3 mt-5">
                    <span className="text-lg text-gray-600 text-[#2997ff] hover:cursor-pointer">Saznajte više o nama</span>
                    <svg 
