...
function Hero() {
    return (
        <section className="flex flex-row justify-center items-center h-full w-full text-slate-100 absolute top-0 left-0">
            <div className="fixed h-screen w-full bg-gradient-to-br from-indigo-100 via-white to-cyan-100"></div>
            <div className="flex flex-col justify-center items-center w-1/2 z-10 gap-3 relative">
                <div className="animate-[float_2s_ease-in-out_infinite] flex flex-col justify-center items-center p-3 bg-warning-200 rounded-full absolute top-0 left-0 shadow-md border border-gray-300" style={{animationDelay: '0.15s', animationFillMode: 'forwards'}}>
                    <img src={trowel} width={40} height={40} alt="Trowel" />
                </div>
                <div className="animate-[float_2s_ease-in-out_infinite] flex flex-col justify-center items-center p-3 bg-warning-200 rounded-full absolute top-[50%] right-0 shadow-md border border-gray-300" style={{animationDelay: '0.55s', animationFillMode: 'forwards'}}>
                ...
                <span className="animate-[fade_0.5s_ease-in] bg-gradient-to-br from-black to-stone-500 bg-clip-text text-center opacity-0 font-display text-4xl font-bold tracking-[-0.02em] text-transparent opacity-1 drop-shadow-sm [text-wrap:balance] md:text-7xl md:leading-[4rem]" style={{animationDelay: '0.10s', animationFillMode: 'forwards'}}>Make your home even cozier.</span>
