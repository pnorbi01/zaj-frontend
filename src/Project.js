    ...
    return (
        <section className="flex flex-col justify-center items-center w-full p-3 relative">
            ...
            <div className="flex flex-row justify-center items-start flex-wrap p-3 w-2/3 gap-5">
                <div className="card flex flex-col justify-start items-center w-3/12 h-44 shadow-md rounded-bl-xl rounded-br-xl border border-gray-200 hover:cursor-pointer">
